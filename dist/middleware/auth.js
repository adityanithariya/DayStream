...
const pinAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const pinAuth = (_a = req === null || req === void 0 ? void 0 : req.headers) === null || _a === void 0 ? void 0 : _a.pinauth;
    if (!pinAuth)
        return res
            .status(401)
    ...
    const pin = crypto_js_1.default.AES.decrypt(pinAuth, user === null || user === void 0 ? void 0 : user.sessionId).toString(crypto_js_1.default.enc.Utf8);
